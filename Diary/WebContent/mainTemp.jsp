        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class="active"><a href="diaryType?action=list"><i class="icon-book"></i>&nbsp;博客分类管理</a></li>
...
<div style="text-align: center">版权所有 tanpan 【博客系统】</div>
</body>
</html>