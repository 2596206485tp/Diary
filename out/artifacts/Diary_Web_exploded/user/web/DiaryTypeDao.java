...
public class DiaryTypeDao {
	...
	public List<DiaryType> diaryTypeCountList(Connection con)throws Exception{
		...
		String sql="SELECT diaryTypeId,typeName,COUNT(diaryId) AS diaryCount FROM t_diary,t_diaryType where t_diary.typeId = t_diaryType.diaryTypeId GROUP BY diaryTypeId";
